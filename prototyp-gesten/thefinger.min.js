...
class TheFinger {
    ...
    on(element) {
        ...
        element.addEventListener('touchcancel', this.#detectGesture);
        element.addEventListener('pointerdown', this.#detectGesture);
        element.addEventListener('pointermove', this.#detectGesture);
        element.addEventListener('pointerup', this.#detectGesture);
        element.addEventListener('pointercancel', this.#detectGesture);
    ...
    off(element) {
        ...
        element.removeEventListener('touchcancel', this.#detectGesture);
        element.removeEventListener('pointerdown', this.#detectGesture);
        element.removeEventListener('pointermove', this.#detectGesture);
        element.removeEventListener('pointerup', this.#detectGesture);
        element.removeEventListener('pointercancel', this.#detectGesture);
    ...
    #detectGesture = (e) => {
        ...
        if(e.pointerType !== "touch") {
            // Allow for non-touch inputs like a mouse
            e.identifier = e.pointerId
            switch (type) {
                case 'pointerdown':
                    this.#handleTouchStart([e], timestamp);
                    break;

                case 'pointermove':
                    if(e.buttons) this.#handleTouchMove([e], timestamp);
                    break;

                case 'pointerup':
                case 'pointercancel':
                    this.#handleTouchEnd([], timestamp);
                    break;
            }
